...
namespace ModuloKart.CustomVehiclePhysics
{
    ...
    public class VehicleBehavior : MonoBehaviour
    {
        ...
        private void VehicleTiltSlope()
        {
            ...
            tempUpDirection = Vector3.Lerp(vehicle_transform.up, VehicleGetSlope(vehicle_transform), tiltLerp_float);
            ...
            {
                tempVehicleRotation = new Quaternion(tempTransform.rotation.x, 0, tempTransform.rotation.z, tempTransform.rotation.w);
